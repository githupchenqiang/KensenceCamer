...
@interface BaseViewController ()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,UISearchBarDelegate ,UIGestureRecognizerDelegate,GCDAsyncSocketDelegate,UITextFieldDelegate>
...
@property (nonatomic ,assign)BOOL IsEngish;
...
//   [self.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:93/255.0 green:164/255.0 blue:213/255.0 alpha:1]];
    
    //26,32,40
    self.view.backgroundColor = [UIColor colorWithRed:43/255.0 green:50/255.0 blue:60/255.0 alpha:1];
//    [self.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:26/255.0 green:35/255.0 blue:41/255.0 alpha:1]];
...
//    self.SenceCountView = [NSMutableArray array]; //自定义view的个数
...
//        NSString *string = [[NSUserDefaults standardUserDefaults]objectForKey:[NSString stringWithFormat:@"%@%d%@",UserNameString,400+i,[NSString stringWithFormat:@"%@",[DataHelp shareData].LocationArray[0][@"name"]]]];
//        if (string != nil) {
...
//        _PanviewTag = 10000+i+1;
        ...
        self.PanviewTag = 1 + i;
        _panview.backgroundColor = [UIColor colorWithRed:127/255.0 green:199/255.0 blue:208/255.0 alpha:1];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    for (int i = 1; i <= integer; i++) {
        ...
        UILabel *label = [[UILabel alloc]init];
        label.frame = CGRectMake(35+ (180)*(i - 1),2,165,30);
            label.backgroundColor = [UIColor colorWithRed:162/255.0 green:163/255.0 blue:167/255.0 alpha:0.7];
...
//            label.layer.borderWidth = 0.2;
        ...
        UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(5 + (180)*(i - 1),17,200,Height4SuperView * 0.17)];
...
- (void)CreatSlipButton
{
    ...
    _button.frame = CGRectMake(CGRectGetMaxX(_BackView.frame), 64,Width4SuperView - CGRectGetMaxX(_BackView.frame),45);
...
- (void)slipButtonAction:(UIButton *)button
{
    ...
    _lipButton.layer.borderWidth = 0.5;
    _lipButton.layer.cornerRadius = 4;
    _lipButton.layer.masksToBounds = YES;

    _lipButton.backgroundColor = [UIColor whiteColor];
...
//    _lipButton.imageEdgeInsets = UIEdgeInsetsMake(10, 20, 20, 30);
    ...
    [_lipButton setFrame:CGRectMake(CGRectGetMaxX(_BackView.frame) - Width4SuperView * 0.2 - (Width4SuperView - CGRectGetMaxX(_BackView.frame)),69, Width4SuperView - CGRectGetMaxX(_BackView.frame), 45)];
    ...
    splitViewControl.view.frame = CGRectMake(Width4SuperView, 67, Width4SuperView*0.223, CGRectGetHeight(_table.frame) + 30);
    ...
    [UIView beginAnimations:nil context:nil];
    [UIView setAnimationDuration:0.7];
    [splitViewControl.view setFrame:CGRectMake(CGRectGetMaxX(_BackView.frame) - Width4SuperView * 0.2, 67,  Width4SuperView*0.223, CGRectGetHeight(_table.frame) + 30)];
    [UIView commitAnimations];
        });
}
...
//    view.hidden = YES;
    ...
    [UIView beginAnimations:nil context:nil];
    [UIView setAnimationDuration:0.7];
    [splitViewControl.view setFrame:CGRectMake(Width4SuperView - 10 ,67, Width4SuperView*0.223 , Height4SuperView * 0.75)];
    [UIView commitAnimations];
}
...
//    Switch.backgroundColor = [UIColor redColor];
    [Switch setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
//    Switch.titleEdgeInsets = UIEdgeInsetsMake(20, -Switch.titleLabel.bounds.size.height - 20, 0, 0);
    ...
    [form setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    ...
    [lightControl setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    ...
    [video setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    ...
    [volume setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
- (void)SetMenu
{
    ...
    _MenuView.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
...
//      make.right.equalTo(self.view.mas_left).with.offset(-4);
    ...
    if (_IsEngish == YES) {
        ...
        [_lightControl setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        ...
        [_SenceControl setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        ...
        [_SenceControl setTitleColor:[UIColor colorWithRed:31/255.0 green:169/255.0 blue:235/255.0 alpha:1] forState:UIControlStateNormal];
...
- (void)CreatSearch
{
    _search = [[UISearchBar alloc]initWithFrame:CGRectMake(0, 0,  Width4SuperView*0.15, 45)];
    _search.searchBarStyle = UISearchBarStyleMinimal;//设置样式
    _search.backgroundColor = [UIColor colorWithRed:26/255.0 green:35/255.0 blue:41/255.0 alpha:1];
...
//{
//    _SearchCoveview = [[UIView alloc]initWithFrame:CGRectMake(0, 0,Width4SuperView, Height4SuperView)];
//    _SearchCoveview.backgroundColor = [UIColor clearColor];
//    _SearchCoveview.alpha = 0.4;
//    
//    [self.view addSubview:_SearchCoveview];
//    
//}
...
{
    _table = [[UITableView alloc]initWithFrame:CGRectMake(0,65, Width4SuperView*0.15,Height4SuperView * 0.66) style:UITableViewStyleGrouped];
    _table.backgroundColor = [UIColor colorWithRed:42/255.0 green:50/255.0 blue:62/255.0 alpha:1];
    _table.delegate = self;
    _table.dataSource = self;
//    _table.bounces = NO;
    [_table registerNib:[UINib nibWithNibName:@"BaseTableViewCell" bundle:nil] forCellReuseIdentifier:TableSampleIdentifier];
//    _table.bounces = NO;
    _table.tableHeaderView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, _table.frame.size.width, 45)];
    _table.tableHeaderView.backgroundColor = [UIColor blackColor];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BaseTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:TableSampleIdentifier];
    ...
    /*
- (KxMovieViewController *)contentViewController
{
    if (_kxMovie) {
        KxMovieViewController *contentViewController = [[KxMovieViewController alloc]init];
        _kxMovie = contentViewController;
...
- (void)addViewControllerToparentViewController:(UIViewController *)parentViewController
{
    ...
    [_kxMovie didMoveToParentViewController:parentViewController];
...
//    [_move removeFromParentViewController];
    [_kxMovie removeFromParentViewController];
    [cell removeFromSuperview];
    [_decoder closeFile];
    [_decoder closeVideoStream];
    
    id<KxAudioManager> audioManager = [KxAudioManager audioManager];
    [audioManager pause];
    
    [audioManager outputBlock];
    _dispatch_queue = NULL;
}
...
- (void)removeViewControllerFromParentViewController
{
    ...
    [_kxMovie.view removeFromSuperview];
    [_kxMovie willMoveToParentViewController:nil];
    [_kxMovie removeFromParentViewController];
...
//    NSString *path = MutArray[indexPath.row];
...
//    
//
//    TViewModel *model = [DataHelp shareData].TAllArray[indexPath.row];
    BaseTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:TableSampleIdentifier forIndexPath:indexPath];
//    cell.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
    
    if (_MutSelsct.count != 0) {
        cell.baseNemeLabel.text = _MutSelsct[indexPath.row];
    }else
    {
        cell.baseNemeLabel.text = [DataHelp shareData].TAllArray[indexPath.row];
    }
    
   
    
    _Cellview = [[UIView alloc]init];
    _Cellview.frame = CGRectMake(0, 0, Width4SuperView*0.15, (Height4SuperView * 0.65)/4);
    _Cellview.tag = 1000 + indexPath.row;
    ...
    [_Cellview addGestureRecognizer:LongPress];
    
    [_Cellview addGestureRecognizer:pan];
    [cell.contentView addSubview:_Cellview];
    
    
    cell.baseNemeLabel.textAlignment = NSTextAlignmentLeft;
    cell.baseNemeLabel.layer.borderWidth = 0.7;
    cell.baseNemeLabel.layer.borderColor = [UIColor blackColor].CGColor;
    cell.baseNemeLabel.textColor = [UIColor whiteColor];
    
    cell.layer.borderColor = [UIColor blackColor].CGColor;
    cell.layer.borderWidth = 0.7;
    cell.baseNemeLabel.tag = 1212 + indexPath.row;
    cell.baseNemeLabel.layer.cornerRadius = 2;
    cell.baseNemeLabel.layer.masksToBounds = YES;
    cell.backgroundColor = [UIColor colorWithRed:16/255.0 green:26/255.0 blue:39/255.0 alpha:1];
    UIButton *button = [UIButton buttonWithType:UIButtonTypeSystem];
    button.frame = CGRectMake(cell.baseNemeLabel.frame.size.width - 25, 2, 25, 26);
//    button.backgroundColor = [UIColor orangeColor];
    [button setBackgroundImage:[UIImage imageNamed:@"CameraSetIcon"] forState:UIControlStateNormal];
    [button addTarget:self action:@selector(setCamerAction:) forControlEvents:UIControlEventTouchDown];
...
//        [_decoder openFile:path error:nil];
    ...
    {   
        ...
        _kxMovie.view.frame = CGRectMake(5, 0,Width4SuperView*0.15 - 10, (Height4SuperView * 0.65)/4 - 20);
        _kxMovie.view.tag = 1000 + indexPath.row;
        UIPanGestureRecognizer *pan = [[UIPanGestureRecognizer alloc]initWithTarget:self action:@selector(MovieViewPan:)];
        [_kxMovie.view addGestureRecognizer:pan];
        [self addChildViewController:_kxMovie];
        [cell.contentView addSubview:_kxMovie.view];
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(5, CGRectGetMaxY(_kxMovie.view.frame), Width4SuperView*0.15 - 10, 20)];
        NSString *text = [NSString stringWithFormat:@"摄像头%ld",(long)indexPath.row];
        label.textAlignment = NSTextAlignmentCenter;
        label.text = text;
...
- (void)setCamerAction:(UIButton *)button
{
    NSLog(@"133444");
}
...
- (void)LongPressAction:(UILongPressGestureRecognizer *)Long
{
    ...
    UIAlertAction *Sure = [UIAlertAction actionWithTitle:Localized(@"确定") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        if (text.text != nil) {
            ...
            if (_MutSelsct.count != 0) {
                NSNumber *number = _MutSelsct[Long.view.tag - 1000];
                NSString *ValueString = [NSString stringWithFormat:@"%@",number];
                UILabel *label = (UILabel *)[self.view viewWithTag:Long.view.tag + 212];
                label.text = text.text;
                [_MutSelsct replaceObjectAtIndex:Long.view.tag - 1000 withObject:text.text];
                for (int i = 0; i < [DataHelp shareData].TAllArray.count; i++) {
                ...
                NSInteger tag = Long.view.tag - 1000;
...
//        _move.view.tag = 10000+self.PanviewTag;
    ...
    }else if (pan.state == UIGestureRecognizerStateChanged)
    {
        ...
        self.YPanView = Loca.frame.origin.y - 43;
        }
        ...
        }else if (pan.state == UIGestureRecognizerStateEnded)
    {
        ...
        if (self.TagNumber == 0) {
            ...
            view.backgroundColor = [UIColor colorWithRed:127/255.0 green:199/255.0 blue:208/255.0 alpha:1];
...
//            NSMutableArray *remutArray = [NSMutableArray array];
//            for (int i = 0; i < _RectArray.count; i++) {
//                NSNumber *number = _RectArray[i];
//                NSString *string = [NSString stringWithFormat:@"%@",number];
//                CGRect rect = CGRectFromString(string);
//                BOOL IsRect = CGRectIntersectsRect(rect,view.frame);
//                if (IsRect == YES) {
//                    [remutArray addObject:[NSNumber numberWithInt:i]];
//                    NSLog(@"====%@",remutArray);
//                }
//                
//            }
...
//                    [_DeschArray addObject:String];
            ...
            }else
            {
                ...
                NSInteger Xinteger = fabs((self.CurrentWith - self.view.frame.size.width * 0.156)/BackWith);
                NSInteger Yinteger = fabs((self.CurrentHeight - self.view.frame.size.height * 0.0898)/BackHeight);
...
//                        view.backgroundColor = [UIColor colorWithRed:111/255.0 green:206/255.0 blue:250/255.0 alpha:1];
                        ...
                        
                    {
                        ...
                        NSString *ValueDtring = [NSString stringWithFormat:@"%ld",_Tinte];
                        NSString *KeyString = [NSString stringWithFormat:@"%ld",(long)inte];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGRect rectInTable  = [tableView rectForRowAtIndexPath:indexPath];
    CGRect rect = [tableView convertRect:rectInTable toView:[tableView superview]];
    _move = [KxMovieViewController movieViewControllerWithContentPath:path parameters:parameters]
    ;
    _move.view.frame = CGRectMake(Width4SuperView*0.15, rect.origin.y, 100,100);
    
 
    
    _move.view.backgroundColor = [UIColor cyanColor];
    _move.view.tag = 500+self.didSelect;
    
    self.allowScrpller = _move.view.tag;
    UITapGestureRecognizer *Tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(TapAction:)];
    Tap.numberOfTapsRequired = 1;
    Tap.numberOfTouchesRequired = 1;

    [_move.view addGestureRecognizer:Tap];
    self.TagNumber = self.allowScrpller;
    [self addChildViewController:_move];
    [self.view addSubview:_move.view];
    
    //创建的view的tag值添加到数组中，
    NSNumber *number = [NSNumber numberWithInteger:_move.view.tag];
    [_MoveViewArray addObject:number];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return (Height4SuperView * 0.65+55)/3.8;
...
//    _SenceSCroller.backgroundColor = [UIColor orangeColor];
    ...
    _SenceSCroller.backgroundColor = [UIColor colorWithRed:24/255.0 green:32/255.0 blue:40/255.0 alpha:1];
...
//    [_Aview addSubview:Emergencybutton];
    ...
    [commandbutton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
//    [_Aview addSubview:commandbutton];
    ...
    [Roundbutton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
- (void)DreawSplitScreen
{
    ...
    _BackView.backgroundColor = [UIColor colorWithRed:32/255.0 green:38/255.0 blue:48/255.0 alpha:1];
...
//    _SaveSence.backgroundColor = [UIColor whiteColor];
...
//    _BackScro.pagingEnabled = YES;
    _BackScro.backgroundColor = [UIColor colorWithRed:43/255.0 green:50/255.0 blue:60/255.0 alpha:1];
...
//    _BackScro.bounces = NO;
    ...
    if ([DataHelp shareData].CustomeIsBool == YES && self.SenceBool == 0) {
        ...
        _BackBlue.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
    ...
    for (int i = 0; i < self.NumberOfScreen; i++) {
        for (int j = 0; j < self.NumberOfScreen; j++) {
            ...
            if (self.NumberOfScreen == 1) {
                ...
                _Oneview.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
                _Oneview.tag = 100+i;
                ...
                _DeLabel.textColor = [UIColor whiteColor];
                ...
                if ([DataHelp shareData].MeetingRnameArray.count != 0) {
                    NSString *TextString = [[NSUserDefaults standardUserDefaults]objectForKey:[NSString stringWithFormat:@"%@%ld%@",UserNameString,_DeLabel.tag,[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingRnameArray[_SenceCount - 1]]]];
                ...
                Twoview.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
...
//                    decomeLabel.backgroundColor = [UIColor orangeColor];
                ...
                view.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
                view.tag = 106+3*j+i;
            ...
            }else if (self.NumberOfScreen == 4)
            {
                ...
                sixView.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
...
- (void)LongViewTag:(NSInteger)Tag
{
    ...
    UIAlertAction *Sure = [UIAlertAction actionWithTitle:Localized(@"确定") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        NSString *string = [NSString stringWithFormat:@"%@%ld%@",UserNameString,Tag + 400,[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingName]];
        ...
        if (_NumberOfScreen == 1) {
            ...
            NSString *string = [NSString stringWithFormat:@"%@%ld%@%@",UserNameString,Tag - 100 + 400,[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingName],[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingDestchanid[Tag - 100]]];
            [[NSUserDefaults standardUserDefaults]setObject:text.text forKey:string];
        }else if (_NumberOfScreen == 2)
        {
            [[DataHelp shareData].MeetingRnameArray replaceObjectAtIndex:Tag - 102 withObject:text.text];
            NSString *string = [NSString stringWithFormat:@"%@%ld%@%@",UserNameString,Tag - 102 + 400,[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingName],[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingDestchanid[Tag - 102]]];
            [[NSUserDefaults standardUserDefaults]setObject:text.text forKey:string];
            
        }else if (_NumberOfScreen == 3)
        {
            [[DataHelp shareData].MeetingRnameArray replaceObjectAtIndex:Tag - 106 withObject:text.text];
            NSString *string = [NSString stringWithFormat:@"%@%ld%@%@",UserNameString,Tag - 106 + 400,[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingName],[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingDestchanid[Tag - 106]]];
            [[NSUserDefaults standardUserDefaults]setObject:text.text forKey:string];
        }else if (_NumberOfScreen == 4)
        {
            [[DataHelp shareData].MeetingRnameArray replaceObjectAtIndex:Tag - 120 withObject:text.text];
            NSString *string = [NSString stringWithFormat:@"%@%ld%@%@",UserNameString,Tag - 120 + 400,[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingName],[NSString stringWithFormat:@"%@",[DataHelp shareData].MeetingDestchanid[Tag - 120]]];
            [[NSUserDefaults standardUserDefaults]setObject:text.text forKey:string];
        }
    }];
    [alert addAction:Cancle];
...
//        保存场景并进行布局与保存数据
        ...
        self.DecomeNumber = 0;
            ...
            [self imageView:[UIApplication sharedApplication].keyWindow atFrame:CGRectMake(CGRectGetMaxX(_table.frame),CGRectGetMaxY(_BackView.frame) + 2,Width4SuperView - Width4SuperView *0.15 -4,Height4SuperView * 0.61 + 28)];
...
//    _BackScro.bounces = NO;
    ...
    _CustomView.backgroundColor = [UIColor colorWithRed:25/255.0 green:32/255.0 blue:40/255.0 alpha:1];
...
//            _Blueview.backgroundColor = [UIColor cyanColor];
    ...
    view.backgroundColor = [UIColor colorWithRed:50/255.0 green:60/255.0 blue:73/255.0 alpha:1];
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 30, 70,30)];
    label.text = [DataHelp shareData].MeetingRnameArray[0];
    label.textColor = [UIColor colorWithRed:121/255.0 green:126/255.0 blue:132/255.0 alpha:1];
    ...
    label.tag = 998;
    label.backgroundColor = [UIColor colorWithRed:50/255.0 green:60/255.0 blue:73/255.0 alpha:1];
    label.textAlignment = NSTextAlignmentCenter;
...
//        [view addGestureRecognizer:pinchGesture];
        ...
        UILabel *CLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 30,view.frame.size.width, 30)];
            ...
            CLabel.textColor = [UIColor colorWithRed:121/255.0 green:126/255.0 blue:132/255.0 alpha:1];
...
//            Label.tag =
        ...
        {
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Edit" message:Localized(@"解码器达到上限不可在编辑") preferredStyle:UIAlertControllerStyleAlert];
        ...
        {
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Edit" message:Localized(@"当前无解码器") preferredStyle:UIAlertControllerStyleAlert];
...
//        UIView *view = (UIView *)[self.view viewWithTag:action.view.tag];
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Edit" message:Localized(@"删除场景") preferredStyle:UIAlertControllerStyleAlert];
...
- (UIImageView *)imageFromView: (UIView *) theView atFrame:(CGRect)r
{
    ...
    _image.frame = CGRectMake(5 + (180)*(_NUmberSave - 1),17,200, Height4SuperView * 0.17);
//    _image.backgroundColor = [UIColor cyanColor];
    _image.userInteractionEnabled = YES;
    _image.image = theImage;
    
    _Sencelabel = [[UILabel alloc]init];
    _Sencelabel.frame = CGRectMake(35 + (180)*(_NUmberSave - 1),2,165,30);
    _Sencelabel.backgroundColor = [UIColor colorWithRed:162/255.0 green:163/255.0 blue:167/255.0 alpha:0.7];
...
//    NSString *string = [[NSUserDefaults standardUserDefaults]objectForKey:@"senceAarray"];
    ...
    [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%ld",(long)_NumberOfScreen] forKey:[NSString stringWithFormat:@"%@%ld",UserNameString,_NUmberSave + 100]];
...
- (void)deleteSence:(NSInteger)senceNumber
{
    ...
    [[NSUserDefaults standardUserDefaults]setObject:_SenceNameArray forKey:[NSString stringWithFormat:@"%@SenceNameSave",UserNameString]];
        ...
        for (int i = (int)_DeleNumber; i < _NUmberSave; i++) {
            ...
            scroller.frame = CGRectMake(5 + (180)*(i - 1),17,200, Height4SuperView * 0.17);
            scroller.tag = i + 555 -1;
            UILabel *labe = (UILabel *)[self.view viewWithTag:1700 + i];
            labe.frame = CGRectMake(35 + (180)*(i - 1),2,165, 30);
            labe.tag = 1700 + i - 1;
...
//        [[NSUserDefaults standardUserDefaults]setObject:mut forKey:[NSString stringWithFormat:@"%@senceAarray",UserNameString]];
    ...
    UIAlertAction *Sure = [UIAlertAction actionWithTitle:Localized(@"修改") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
- (void)CameraSeltButtonAction:(UIButton *)CamerSele
{
    ...
    [_table setContentOffset:CGPointMake(0, 200 * _Leftindex +(Height4SuperView * 0.65)/4) animated:YES];

    
    if ((Height4SuperView * 0.65)/4 * [DataHelp shareData].TAllArray.count < Height4SuperView * 0.65 * _Leftindex ) {
...
-(void)panAction:(UIPanGestureRecognizer *)pan
{
    ...
    }else if (pan.state == UIGestureRecognizerStateChanged) //平移
    {
        ...
        self.YPanView = view.frame.origin.y  - 41;
...
//                    [_DeschArray replaceObjectAtIndex:arrCount withObject:destdevString];
            ...
            if (self.CurrentWith  <= Width4SuperView * 0.15/2 || self.CurrentWith + view.frame.size.width/2 >= Width4SuperView * 0.8|| self.CurrentHeight <= 30 || self.CurrentHeight >= Height4SuperView * 0.71 - view.frame.size.height/2 ) {
                ...
                NSString *string = [NSString stringWithFormat:@"%ld",pan.view.tag];
...
- (void)SenceControlAction:(UIButton *)button
{
    ...
    if (_IsEngish == YES) {
        ...
        [Sencebutton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        ...
        [Lightbutton setTitleColor:[UIColor colorWithRed:31/255.0 green:169/255.0 blue:235/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    [Sencebutton setTitleColor:[UIColor colorWithRed:31/255.0 green:169/255.0 blue:235/255.0 alpha:1] forState:UIControlStateNormal];
    SenceImage = [SenceImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [Sencebutton setImage:SenceImage forState:UIControlStateNormal];
...
- (void)videoButtonAction:(UIButton *)video
{
    ...
    [Videobutton setTitleColor:[UIColor colorWithRed:31/255.0 green:169/255.0 blue:235/255.0 alpha:1] forState:UIControlStateNormal];
    VideoImage = [VideoImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [Videobutton setImage:VideoImage forState:UIControlStateNormal];
...
}else
{
    ...
    [Typebutton setTitleColor:[UIColor colorWithRed:31/255.0 green:169/255.0 blue:235/255.0 alpha:1] forState:UIControlStateNormal];
    TypeImage = [TypeImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [Typebutton setImage:TypeImage forState:UIControlStateNormal];
