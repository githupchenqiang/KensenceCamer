...
//            NSLog(@"PicTag ==%ld",(long)PicTag);
//            NSLog(@"viewTag ===%ld",(long)Viewtag);
//            NSLog(@"SenceNumber ===%ld",SenceNumber);
//            NSLog(@"senceR ===%ld",(long)SenceR);
//            NSLog(@"Tlink ==%ld",TLinkTag);
//            
//            NSLog(@"view======%@",dataHelp.ViewTag);
//            NSLog(@"%@",dataHelp.SenceNumberArray);
//            NSLog(@"%@",dataHelp.SenceRArray);
//            NSLog(@"%@",DeschString);
//            NSLog(@"查询语句没问题");
        }
