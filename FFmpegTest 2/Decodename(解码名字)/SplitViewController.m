...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithRed:42.0/255.0 green:50.0/255.0 blue:62/255.0 alpha:0.4];
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH *0.07 -35,0, 150, 40)];
    ...
    for (int i = 0; i < 1; i++) {
        for (int j = 0; j < [DataHelp shareData].LocationArray.count; j++) {
            UIView *View = [[UIView alloc]initWithFrame:CGRectMake(2, 60 +  (WIDTH * 0.22 *0.56688654 + 60) * j , WIDTH * 0.22, WIDTH * 0.22 *0.56688654)];
...
//            View.backgroundColor = [UIColor colorWithRed:189.0/255.0 green:189.0/255.0 blue:189.0/255.0 alpha:1];
            View.tag = 3000 + j;
             View.backgroundColor = [UIColor colorWithRed:16/255.0 green:26/255.0 blue:39/255.0 alpha:1];
            ...
            label.backgroundColor = [UIColor colorWithRed:111/255.0 green:206/255.0 blue:250/255.0 alpha:1];
            }
...
//        NSInteger count =  Base.SenceCount;
    ...
    for (int i = 0; i < [DataHelp shareData].LocationArray.count; i++) {
        ...
        if (imageData != nil) {
            ...
            UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(-32,-15, WIDTH * 0.24, WIDTH * 0.22 * 0.75688654)];
...
//    NSLog(@"%@",[DataHelp shareData].MeetingDestchanid);
//    NSLog(@"%@",[DataHelp shareData].MeetingDestdevid);
//    NSLog(@"%@",[DataHelp shareData].MeetingRnameArray);
...
- (void)RequestAction:(UITapGestureRecognizer *)tap
{
    if (tap.state == UIGestureRecognizerStateEnded) {
        ...
        if ([DataHelp shareData].destchanidArray.count != 0) {
            ...
            NSString *string = [NSString stringWithFormat:@"%ld",tap.view.tag];
...
- (void)LongAction:(UILongPressGestureRecognizer *)Long
{
    if (Long.state == UIGestureRecognizerStateBegan) {
        ...
        if ([DataHelp shareData].destchanidArray.count != 0) {
            ...
            alert= [UIAlertController alertControllerWithTitle:@"Edit" message:Localized(@"会场列表删除") preferredStyle:UIAlertControllerStyleAlert];
