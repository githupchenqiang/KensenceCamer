...
//                _LocationArray = [NSMutableArray array];
                ...
                /*
                for (NSDictionary *media in deviceArray[@"medialinks"]) {
                    [_medialinksArray addObject:media];
                }
             
                _userMessage = [NSMutableArray array];
                for (NSDictionary *Userdic in deviceArray[@"user"]) {
                    [_userMessage addObject:Userdic];
                }
                _usersGroupArray = [NSMutableArray array];
                for (NSDictionary *groupArr in deviceArray[@"users"]) {
                    [_usersGroupArray addObject:groupArr];
                }
                 */
